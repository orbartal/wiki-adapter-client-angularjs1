(function () {
    'use strict';
      ...
      function actionsOnArticlesTable (SiteConfigService, $uibModal, $state, toaster){
            ...
            directive.scope =  {};
            directive.templateUrl = '/app/src/v1/ui/directives/articles-table/actions.on.articles.directive.html';
            //'/app/common/directives/articles-table/actions.on.articles.table.html';
	      ...
	      function actionsLinking (scope, element, attrs, ctrl){
	    	  ...
	    	  function openCreateArticleDialog () {
		          	...
		          	var modalInstance = $uibModal.open({
		          		backdrop : 'static',
		  				size: "lg",
		  				templateUrl: '/app/src/v1/ui/modal/article/create/article.create.modal.html',

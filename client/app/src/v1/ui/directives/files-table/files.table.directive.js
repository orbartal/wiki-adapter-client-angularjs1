(function () {
    ...
    //http://ng-table.com/#/editing/demo-inline
      ...
      function filesTable (SiteConfigService, $uibModal, $state, toaster, NgTableParams){
            ...
            directive.templateUrl = '/app/src/v1/ui/directives/files-table/files.table.directive.html';
	          ...
	          function initializeOptions (){
	  	     ...
	  	     function openAddNewFileDialog () {
		          	var modalInstance = $uibModal.open({
		          		backdrop : 'static',
		  				size: "lg",
		  				templateUrl: '/app/pages/file/modal/create/modal.add.new.file.html',
